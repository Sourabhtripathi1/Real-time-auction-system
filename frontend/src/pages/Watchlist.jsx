  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        ...
        <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Auctions you&apos;re tracking</p>
      </div>
      ...
      {!loading && items.length === 0 && (
        <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-200 dark:border-gray-800 p-12 text-center">
          ...
          <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Your watchlist is empty</h2>
          <p className="text-gray-500 dark:text-gray-400 mb-6">Start browsing auctions and add items to your watchlist.</p>
          <button
              ...
              >
                <div>
                  <div className="flex items-start justify-between gap-2 mb-3">
                    ...
                    <span className={`shrink-0 inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium ${STATUS_STYLES[auction.status] || 'bg-gray-100 text-gray-600 dark:bg-gray-800 dark:text-gray-400'}`}>
                      {auction.status}
                    </span>
                  </div>
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="text-gray-700 dark:text-gray-300">{formatDate(auction.endTime)}</span>
                    </div>
                  </div>
                </div>
