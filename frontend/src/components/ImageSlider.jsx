...
const Placeholder = ({ height }) => (
  <div className={`w-full ${height} bg-gray-100 dark:bg-gray-800 flex flex-col items-center justify-center gap-2`}>
    ...
    <span className="text-xs text-gray-400 dark:text-gray-600 font-medium">No Images Available</span>
  </div>
);
...
const ImageSlider = ({
  ...
  const goNext = useCallback(() => setCurrentIndex((c) => Math.min(total - 1, c + 1)), [total]);
  ...
  return (
    <div className="w-full select-none">
      ...
      >
        ...
        {/* Navigation Arrows */}
        {total > 1 && currentIndex > 0 && <ArrowBtn direction="left" onClick={goPrev} />}
        {total > 1 && currentIndex < total - 1 && <ArrowBtn direction="right" onClick={goNext} />}
