        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          <div>
            ...
            {auction?.images?.length > 0 ? (
              <div className="mt-2 mb-4 grid grid-cols-5 gap-2">
                {auction.images.map((img, i) => (
                  <div
                    key={i}
                    className="aspect-square rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800">
                    <img
                      src={img.url}
                      alt="current"
            ...
            <label className={labelClass}>
              ...
              <span className="font-normal text-amber-500 ml-2 text-xs">
            ...
            {previewUrls.length > 0 && (
              <div className="mt-3 grid grid-cols-5 gap-2">
                {previewUrls.map((url, i) => (
                  <div
                    key={i}
                    className="aspect-square rounded-lg overflow-hidden border border-amber-200 dark:border-amber-700/50 bg-amber-50 dark:bg-amber-900/20">
                    <img
                      src={url}
                      alt="preview"
