...
const ThumbsIcon = () => (
  <svg
    ...
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M14 10h4.764a2 2 0 011.789 2.894l-3.5 7A2 2 0 0115.263 21h-4.017a2 2 0 01-1.415-.586l-3.535-3.536m7.35-4.878A4 4 0 0012 6H8.5a4 4 0 00-4 4v3.586m7.35-4.878L6 17"
    />
  </svg>
);
      ...
      {cards.map((card) => {
        ...
        return (
          <button
            ...
            <div className="flex items-start gap-3">
              <div
                className={`shrink-0 w-10 h-10 rounded-xl ${card.iconBg} flex items-center justify-center ${card.color}`}>
                {card.key === "active" ? (
